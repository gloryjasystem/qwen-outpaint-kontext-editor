...
- [Upscaling Workflows](#upscaling-workflows)
  * [1. Pure Upscaling (`test_upscaler_pure.json`)](#1-pure-upscaling-test_upscaler_purejson)
  * [2. Minimal AI Enhancement (`test_upscaler_minimal.json`)](#2-minimal-ai-enhancement-test_upscaler_minimaljson)
  * [3. Full AI Enhancement (`test_upscaler.json`)](#3-full-ai-enhancement-test_upscalerjson)
